...
const ManagementDashboard = () => {
  ...
  const alerts = [
    { type: 'warning', message: 'Deteksi keterlambatan massal di departemen IT', time: '2 menit yang lalu' },
    { type: 'info', message: 'Laporan kehadiran bulanan siap untuk ditinjau', time: '1 jam yang lalu' },
    { type: 'error', message: 'Pola ketidakhadiran tidak biasa di tim Keuangan', time: '3 jam yang lalu' }
  ]

  const topPerformers = [
    { name: 'Sarah Johnson', department: 'IT', attendance: '98%', punctuality: '95%' },
    { name: 'Mike Chen', department: 'Penjualan', attendance: '97%', punctuality: '92%' },
    { name: 'Lisa Wang', department: 'HR', attendance: '96%', punctuality: '94%' },
    { name: 'David Kim', department: 'Keuangan', attendance: '95%', punctuality: '90%' }
  ]
    ...
    <div className="bg-gray-50 min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-1">Dashboard Manajemen</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-2xl shadow border border-gray-100">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Kehadiran Departemen</h3>
          ...
          <div className="bg-white p-6 rounded-2xl shadow border border-gray-100">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Peringatan Real-time</h3>
              ...
              {topPerformers.map((performer, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-medium text-green-600">{performer.attendance} kehadiran</p>
                    <p className="text-xs text-gray-500">{performer.punctuality} ketepatan waktu</p>
                  </div>
                </div>
              ))}
            </div>
